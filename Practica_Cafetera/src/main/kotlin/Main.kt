...
class Cafetera(ubicacion: String) {
    ...
    fun llenar(llenar: Int) {
        if(llenar==0){
            this.cantidad=0
        }else{
            this.cantidad = this.cantidad+llenar
        }
    }

    override fun toString(): String {
        return "Cafetera(nombre='$ubicacion', capacidad=$capacidad, cantidad=$cantidad)"
    }

}

class Taza(color: String = "blanco", capacidad: Int = 50) {
...
fun main() {
    ...
    var c1 = Cafetera("Sala")
    var c2 = Cafetera("Cocina", 750)
    var c3 = Cafetera("Oficina", 500, 200)
